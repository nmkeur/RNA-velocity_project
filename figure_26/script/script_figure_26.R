...
png("~/RNA-velocity_project/figure_26/figure/figure_26.png", width = 1500, height = 1800, units='px', res = 200)
plot_grid(Scribe::plot_gene_pairs_in_pseudotime(CDS_predicted_velocity, gene_pairs_mat,
                                                n_col = 2,
                                                fitting_type = 'loess',
                                                relative_expr = TRUE) +
            labs(color='')+
          ...
          Scribe::plot_lagged_drevi(CDS_predicted_velocity,
                                    gene_pairs_mat,
                                    d=1,
                                    n_col = 2),
          labels = c("A", "B"))
