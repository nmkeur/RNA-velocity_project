...
ucrdi_list_monocle[ucrdi_list_monocle <= 0] <- 0
...
load('~/Desktop/CDS_predicted_monocle_10_genes.RData')
ucrdi_list_monocle <- urdi_list_monocle$max_rdi_value
ucrdi_list_monocle[ucrdi_list2 <= 0] <-0
...
png("~/RNA-velocity_project/figure_23/figure/figure_23.png", width = 1500, height = 1800, units='px', res = 200)
